...
class tableAccount: Object, NCUserBaseUrl {
    ...
    @objc dynamic var autoUploadBackground: Bool = true
    @objc dynamic var autoUploadCreateSubfolder: Bool = true
    ...
    @objc dynamic var backendCapabilitiesSetDisplayName: Bool = true
